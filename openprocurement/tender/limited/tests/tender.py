...
from openprocurement.api.tests.tender import (empty_listing,
                                              listing_draft,
                                              get_tender,
                                              dateModified_tender,
                                              tender_not_found)
...
class BaseLimitedTenderResourceTest(object):
...
class TenderResourceTest(BaseTenderWebTest, BaseLimitedTenderResourceTest):
